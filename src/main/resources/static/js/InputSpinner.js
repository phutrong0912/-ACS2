...
export class InputSpinner {
    ...
    constructor(element, props) {
        ...
        this.props = {
            decrementButton: "<i class=\"ti ti-minus\"></i>", // button text
            incrementButton: "<i class=\"ti ti-plus\"></i>", // ..
            ...
            template: // the template of the input
                ...
                '<button style="width: ${buttonsWidth}; height: ${height}; display: flex; align-items: center; justify-content: center;" class="btn btn-decrement ${buttonsClass} btn-minus" type="button">${decrementButton}</button>' +
                '<input type="text" inputmode="numeric" pattern="[0-9]*" style="text-align: center; height: ${height}" class="form-control form-control-text-input" oninput="this.value = this.value.replace(/[^0-9]/g, \'\')"/>' +
                '<button style="width: ${buttonsWidth}; height: ${height}; display: flex; align-items: center; justify-content: center;" class="btn btn-increment ${buttonsClass} btn-plus" type="button">${incrementButton}</button>' +
                '</div>',
            height: "26px",
        }
        ...
        const html = this.props.template
            ...
            .replace(/\${height}/g, this.props.height) 
